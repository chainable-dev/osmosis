...
type LockKeeper interface {
	...
	LockTokens(context.Context, *types.MsgLockTokens) (*types.MsgLockTokensResponse, error)
	// BeginUnlockingAll begin unlocking all tokens
	BeginUnlockingAll(context.Context, *types.MsgBeginUnlockingAll) (*types.MsgBeginUnlockingAllResponse, error)
	// MsgBeginUnlocking begins unlocking tokens by lock ID
	BeginUnlocking(context.Context, *types.MsgBeginUnlocking) (*types.MsgBeginUnlockingResponse, error)
}
...
func LockKeeperImpl(keeper *Keeper) LockKeeper {
	return &msgServer{
		keeper: keeper,
	}
}
